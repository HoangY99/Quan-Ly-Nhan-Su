...
<body>
    ...
    <header>
        ...
        <div id="login">            
            <a href="http://localhost/quanlynhansu/Login/logout">Đăng xuất</a>
        </div>
            ...
            <div id="row">
                <div id="col-sm-3">
                    <ul>
                        ...
                        <li><a href="http://localhost/quanlynhansu/ThemNV/display">Thêm nhân viên</a></li>
                        <li><a href="http://localhost/quanlynhansu/CapNhatPB/Display">Cập nhật thông tin phòng ban</a></li>
                        <li><a href="http://localhost/quanlynhansu/XoaNV/display">Xóa nhân viên</a></li>
                        <li><a href="http://localhost/quanlynhansu/XoaNhieuNV/display">Xóa nhiều nhân viên</a></li>
                    </ul>
                </div>
                <div id="col-sm-9">
